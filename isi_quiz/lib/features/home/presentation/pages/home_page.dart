...
class _HomePageState extends State<HomePage> {
  ...
  /// Vide tous les champs PIN et réinitialise l'état d'erreur.
  void _clearPin() {
    for (final c in _pinControllers) c.clear();
    setState(() { _hasError = false; _errorMessage = ''; });
    // Ne pas re-focus pour ne pas rouvrir le clavier après navigation
  }
  ...
  Future<void> _joinQuiz() async {
    ...
    try {
      ...
      // ✅ Vider le PIN AVANT la navigation
      _clearPin();

      await Navigator.push(
        context,
        MaterialPageRoute(builder: (_) => JoinQuizPage(quiz: quizData)),
      );
      // Le PIN est déjà vide au retour, rien à faire de plus.
    } catch (e) {
      setState(() {
        _hasError = true;
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  isInstructor
                                      ? 'Gérez vos quiz ou créez-en un nouveau.'
                                  ...
                                  TextButton(
                                    onPressed: () =>
                                        widget.onNavigate?.call(1,
                                            quizTab: 1),
                                    child: Text(
                                      'Pas de code ? Explorer les quiz publics →',
                                      style: TextStyle(
                                  ...
                                  if (!isInstructor)
                                    Container(
                                      ...
                                      child: Row(children: [
                                        ...
                                        Expanded(
                                          child: Text(
                                            'Entrez le code PIN de votre instructeur pour rejoindre un quiz.',
                                            style: TextStyle(
                                              color: primaryColor
                                                  .withOpacity(0.7),
                                              fontSize: 13,
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(
          backgroundColor:
              active ? primaryColor : Colors.grey.shade300,
